...
betau = rand(744, 1);
betad = rand(744, 1);
zeros = [25, 32, 41, 50, 52, 55, 66, 70, 81, 101, 141, 147, 155, 158, 161, 175, 187, 197, 221, 224, 228, 234, 237, 244, 246, 249, 254, 258, 269, 270, 277, 294, 301, 305, 328, 339, 363, 364, 366, 393, 416, 441, 447, 450, 475, 476, 482, 488, 498, 501, 507, 508, 511, 524, 548, 550, 560, 575, 586, 600, 603, 618, 620, 629, 634, 640, 649, 653, 684, 686, 726, 739];
...
cons16 = ru == alpha_SR * rd; 
cons17 = ed == deltat_SR * rd .* betad; 
